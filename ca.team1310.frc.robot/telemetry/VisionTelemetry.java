package ca.team1310.frc.robot.telemetry;
...
public class VisionTelemetry {
    ...
    void post() {
        if (
            Telemetry.vision.telemetryLevel == VisionTelemetryLevel.REGULAR ||
            Telemetry.vision.telemetryLevel == VisionTelemetryLevel.VERBOSE
        ) {
            String poseOdo = String.format(
                "(%.2f, %.2f)m %.1f°",
                poseMetresX,
                poseMetresY,
                poseHeadingDegrees
            ...
            String poseDelta = String.format(
                "%.2fm, %.1f°",
                poseDeltaMetres,
                headingDeltaDegrees
            );
            ...
            SmartDashboard.putNumber(
                PREFIX + "Vision/tag_ambiguity",
                tagAmbiguity
            );

            SmartDashboard.putString(
                PREFIX + "Vision/yaw_navx",
                String.format("%.2f°", navxYaw)
            );

            SmartDashboard.putString(
                PREFIX + "Vision/yaw_navx_delta",
                String.format("%.2f°", navxYawDelta)
            );
        }

        if (Telemetry.vision.telemetryLevel == VisionTelemetryLevel.VERBOSE) {
            String poseVisSeries = String.format(
                "(%.2f, %.2f)m %.1f°",
            ...
            SmartDashboard.putString(
                PREFIX + "Vision/pose_vis_range",
                poseVisSeries
            );

            SmartDashboard.putNumberArray(
                PREFIX + "Vision/nik_visible_tags",
                nikVisibleTags
            );
            SmartDashboard.putNumber(PREFIX + "Vision/nik_tx", nikTx);
            SmartDashboard.putNumber(
                PREFIX + "Vision/nik_distanceToRobot",
                nikDistanceToRobot
            );
            SmartDashboard.putNumber(
                PREFIX + "Vision/nik_distanceToCam",
                nikDistanceToCam
            );

            SmartDashboard.putNumberArray(
                PREFIX + "Vision/tom_visible_tags",
                tomVisibleTags
            );
            SmartDashboard.putNumber(PREFIX + "Vision/tom_tx", tomTx);
            SmartDashboard.putNumber(
                PREFIX + "Vision/tom_distanceToRobot",
                tomDistanceToRobot
            );
            SmartDashboard.putNumber(
                PREFIX + "Vision/tom_distanceToCam",
                tomDistanceToCam
            );
        }
    }
