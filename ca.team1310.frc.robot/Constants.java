...
public final class Constants {
    ...
    public static final class FieldConstants {
        ...
        public enum TAGS {
            RED_LEFT_SOURCE(
                1,
                new Pose2d(16.697198, 0.655320, Rotation2d.fromDegrees(-54))
            ),
            RED_RIGHT_SOURCE(
                2,
                new Pose2d(16.697198, 7.396480, Rotation2d.fromDegrees(54))
            ),
            RED_PROCESSOR(
                3,
                new Pose2d(11.560810, 8.055610, Rotation2d.fromDegrees(90))
            ),
            RED_RIGHT_BARGE(
                4,
                new Pose2d(9.276080, 6.137656, Rotation2d.fromDegrees(180))
            ),
            RED_LEFT_BARGE(
                5,
                new Pose2d(9.276080, 1.914906, Rotation2d.fromDegrees(180))
            ),
            RED_LEFT_REEF_2_3(
                6,
                new Pose2d(13.474446, 3.306318, Rotation2d.fromDegrees(120))
            ),
            RED_LEFT_RIGHT_REEF_1(
                7,
                new Pose2d(13.890498, 4.025900, Rotation2d.fromDegrees(180))
            ),
            RED_RIGHT_REEF_2_3(
                8,
                new Pose2d(13.474446, 4.745482, Rotation2d.fromDegrees(-120))
            ),
            RED_RIGHT_REEF_4_5(
                9,
                new Pose2d(12.643358, 4.745482, Rotation2d.fromDegrees(-60))
            ),
            RED_RIGHT_LEFT_REEF_6(
                10,
                new Pose2d(12.227306, 4.025900, Rotation2d.fromDegrees(0))
            ),
            RED_LEFT_REEF_4_5(
                11,
                new Pose2d(12.643358, 3.306318, Rotation2d.fromDegrees(60))
            ),
            BLUE_RIGHT_SOURCE(
                12,
                new Pose2d(0.851154, 0.655320, Rotation2d.fromDegrees(-126))
            ),
            BLUE_LEFT_SOURCE(
                13,
                new Pose2d(0.851154, 7.396480, Rotation2d.fromDegrees(126))
            ),
            BLUE_LEFT_BARGE(
                14,
                new Pose2d(8.272272, 6.137656, Rotation2d.fromDegrees(0))
            ),
            BLUE_RIGHT_BARGE(
                15,
                new Pose2d(8.272272, 1.914906, Rotation2d.fromDegrees(0))
            ),
            BLUE_PROCESSOR(
                16,
            ...
            BLUE_RIGHT_REEF_2_3(
                17,
                new Pose2d(4.073906, 3.306318, Rotation2d.fromDegrees(60))
            ),
            BLUE_RIGHT_LEFT_REEF_1(
                18,
                new Pose2d(3.657600, 4.025900, Rotation2d.fromDegrees(0))
            ),
            BLUE_LEFT_REEF_2_3(
                19,
                new Pose2d(4.073906, 4.745482, Rotation2d.fromDegrees(-60))
            ),
            BLUE_LEFT_REEF_4_5(
                20,
                new Pose2d(4.904740, 4.745482, Rotation2d.fromDegrees(-120))
            ),
            BLUE_LEFT_RIGHT_REEF_6(
                21,
                new Pose2d(5.321046, 4.025900, Rotation2d.fromDegrees(180))
            ),
            BLUE_RIGHT_REEF_4_5(
                22,
                new Pose2d(4.904740, 3.306318, Rotation2d.fromDegrees(120))
            );
    ...
    public static final class Swerve {
        ...
        public static final GyroConfig GYRO_CONFIG = GyroConfig.pigeon2(
            8,
            true
        );
        ...
        private static final EncoderConfig ANGLE_ENCODER_CONFIG =
            new EncoderConfig(false, 0.005, 5);
    ...
    public static final class AutoConstants {
        ...
        public enum FieldLocation {
            ...
            PRE_SCORE_LEFT_2(
                new Pose2d(3.2585, 5.8278, Rotation2d.fromDegrees(300)),
                19,
                6,
                false
            ),
            ...
            PRE_SCORE_LEFT_6(
                new Pose2d(6.1660, 4.16, Rotation2d.fromDegrees(180)),
                21,
                10,
                false
            ),
            ...
            PRE_SCORE_RIGHT_2(
                new Pose2d(3.25, 2.23, Rotation2d.fromDegrees(60)),
                17,
                8,
                true
            ),
            PRE_SCORE_RIGHT_3(
                new Pose2d(3.7943, 2.64, Rotation2d.fromDegrees(60)),
                17,
                8,
                false
            ),
            PRE_SCORE_RIGHT_4(
                new Pose2d(5.1843, 2.5, Rotation2d.fromDegrees(120)),
                22,
                9,
                true
            ),
            ...
            PRE_INTAKE_CENTRE_LEFT_STATION(
                new Pose2d(1.139, 7.000, Rotation2d.fromDegrees(126)),
                13,
                1
            ),
            PRE_INTAKE_CENTRE_RIGHT_STATION(
            ...
            blueRightOuterStation(
                new Pose2d(1.15, 1.02, Rotation2d.fromDegrees(234)),
                12,
                2
            ),
            blueLeftOuterStation(
                new Pose2d(1.15, 7.03, Rotation2d.fromDegrees(-234)),
                13,
                1
            ),
            ...
            blueRightExitTransit(
                new Pose2d(4.40, 0.90, Rotation2d.fromDegrees(180))
            ),
            redLeftExitTransit(
                new Pose2d(
            ...
            blueLeftExitTransit(
                new Pose2d(4.40, 6.50, Rotation2d.fromDegrees(0))
            ),
            ...
            blueRightPickupTransit(
                new Pose2d(2.80, 1.70, Rotation2d.fromDegrees(-135))
            ),
            blueLeftPickupTransit(
                new Pose2d(
                    2.80,
                    FIELD_EXTENT_METRES_Y - 2.22,
                    Rotation2d.fromDegrees(135)
                )
            );
