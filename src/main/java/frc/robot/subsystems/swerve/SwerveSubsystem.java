...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public void updateVisionPose(
      Pose2d visionPose, Pose2d secondaryVisionPose, double timestamp, boolean isValid) {
    if (Constants.TelemetryConfig.odometryDebugEnabled) {
      Telemetry.odometryDebug.updateVisionPose(visionPose, secondaryVisionPose, timestamp, isValid);
    }
  }
