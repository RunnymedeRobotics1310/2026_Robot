...
public final class Constants {
  ...
  public static final class ShooterConstants {
    ...
    public static final double SLOPE_VALUE_SUPER_FAR = 487.97; // CHANGE ALL SLOPES AND Y INTS *****
    public static final double Y_INT_SUPER_FAR = 2216.94;
    public static final double SUPEPR_FAR_SHOOTING_DISTANCE = 4.0;
    public static final double SUPER_FAR_SHOOT_HOOD_VALUE = 1.0;
    ...
    public static final double FAR_SHOOTING_DISTANCE = 2.5;
  ...
  public static final class VisionConstants {
    ...
    public static final String VISION_PRIMARY_LIMELIGHT_NAME = "hugh"; // swapped for testing
