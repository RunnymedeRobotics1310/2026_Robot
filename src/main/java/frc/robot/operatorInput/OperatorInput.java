...
public class OperatorInput extends SubsystemBase {
  ...
  public void configureButtonBindings(
    ...
    // Shoot from anywhere
    new Trigger(this::shootFromAnywhere).whileTrue(new ShooterCommand(hopper, swerve));
    ...
    //   tune hopper controls
    //     POV up/down - adjust hopper speed
    ...
    new Trigger(this::isCloseShoot).whileTrue(new LazyShooterCommand(hopper, 3000, 0, 100));
...
//    new Trigger(driverController::getXButton)
//        .onTrue(new TuneShooterCommand(hopper, this, swerve, intake));
  }
