...
public class DriveDistanceCommand extends LoggingCommand {
  ...
  public DriveDistanceCommand(
      ...
      @ConfigParam(
              value = "direction",
              unit = "deg",
              description = "Field-oriented direction of travel")
          double direction,
      @ConfigParam(
              value = "speedMPS",
              unit = "m/s",
